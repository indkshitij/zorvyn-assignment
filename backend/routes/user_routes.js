...
import { protect, protectToChangeActiveStatus } from "../middlewares/auth_middleware.js";
...
router.put("/update-status", protectToChangeActiveStatus, authorizeRoles("admin"), updateStatus);
